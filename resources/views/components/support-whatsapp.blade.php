...
<a
    ...
    @class([
        'group fixed right-4 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-cimuning-whatsapp text-white shadow-[0_8px_28px_rgba(16,185,129,0.32)] transition hover:-translate-y-0.5 hover:brightness-95 focus:outline-2 focus:outline-offset-2 md:right-6',
