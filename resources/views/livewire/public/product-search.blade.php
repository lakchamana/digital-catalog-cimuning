<div x-data="{ filtersOpen: false }" class="bg-white py-10 md:py-16">
    <div class="container-cimuning">
        ...
        <div class="mt-8 grid gap-8 lg:grid-cols-[280px_1fr] lg:items-start">
            <aside class="hidden rounded-card border border-cimuning-border bg-cimuning-section p-5 lg:block">
                @include('livewire.public.partials.product-filters')
            </aside>

            <section>
                <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-cimuning-charcoal">Hasil katalog</h2>
                        <p class="mt-2 text-base text-cimuning-slate">{{ $products->total() }} produk atau jasa ditemukan.</p>
                    </div>
    ...
    >
        <div class="mb-5 flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold text-cimuning-charcoal">Filter Produk</h2>
