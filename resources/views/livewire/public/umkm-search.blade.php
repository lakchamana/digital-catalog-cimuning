        ...
        <div class="rounded-card border border-cimuning-border bg-white p-4 shadow-card md:p-5">
                ...
                <div class="mt-3 grid gap-3 lg:grid-cols-[1fr_auto]">
                    <div class="flex min-h-11 overflow-hidden rounded-input border border-cimuning-border bg-white transition focus-within:border-cimuning-red focus-within:outline-2">
                        <input
                            ...
                            placeholder="Contoh: warung nasi, laundry, RW 07..."
            ...
            <div class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <p class="text-sm leading-6 text-cimuning-slate">
                    Cari nama UMKM, produk, jasa, kategori, atau RW.
                </p>
        ...
        <div class="mt-8 grid gap-8 lg:grid-cols-[280px_1fr] lg:items-start">
            <aside class="hidden rounded-card border border-cimuning-border bg-cimuning-section p-5 lg:block" aria-label="Filter UMKM">
                <div class="mb-5 flex items-start justify-between gap-3">
                    <div>
                        <h2 class="text-lg font-bold text-cimuning-charcoal">Saring UMKM</h2>
                        <p class="mt-1 text-sm leading-6 text-cimuning-slate">Persempit direktori berdasarkan kategori, lokasi, dan layanan.</p>
                    </div>
                    @if ($activeFilterCount > 0)
                        <button
                            type="button"
            ...
            <section aria-labelledby="umkm-results-heading">
                <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                    <div>
                        <h2 id="umkm-results-heading" class="text-2xl font-bold text-cimuning-charcoal">{{ $resultHeading }}</h2>
                        <p class="mt-2 text-base text-cimuning-slate" aria-live="polite" aria-atomic="true">
                            Ditemukan {{ $umkms->total() }} UMKM verified yang bisa dihubungi langsung.
                        </p>
                    </div>
                </div>
